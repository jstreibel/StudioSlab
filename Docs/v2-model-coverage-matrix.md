...
| Ising lattice Monte Carlo | `V2-M` | `P1` | step / pseudo-time | lattice | **yes** | low/medium | lattice field + stats | high (RNG) | hist/diag/spec | V2 headless + passive monitor now wired (`Studios ising`, `LabV2` launcher) |
