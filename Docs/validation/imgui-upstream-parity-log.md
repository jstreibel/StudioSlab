...
- Date: 2026-02-27
- Profile: `quality-gate (extended)`
- Build:
  - `Scripts/quality-gate.sh --with-runtime`
- Runtime tests:
  - upstream-default and legacy-flag-on smoke logs generated by gate script
- Result: `Pass`
- Deltas observed:
  - same non-fatal font deletion warning.
- Evidence:
  - `Build/logs/imgui-runtime-smoke/20260227-211550-upstream-default.log`
  - `Build/logs/imgui-runtime-smoke/20260227-211559-legacy-flag-on.log`
- Follow-up fix commit: _pending_
