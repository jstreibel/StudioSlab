#ifndef STUDIOSLAB_ISING_METROPOLIS_PASSIVE_MONITOR_WINDOW_V2_H
#define STUDIOSLAB_ISING_METROPOLIS_PASSIVE_MONITOR_WINDOW_V2_H
...
namespace Slab::Studios::Common::Monitors::V2 {
    ...
    class FIsingMetropolisPassiveMonitorWindowV2 final : public Graphics::FWindowPanel {
        ...
        TPointer<Math::R2toR::NumericFunction_CPU> DisplaySpins = nullptr;
    ...
    DefinePointers(FIsingMetropolisPassiveMonitorWindowV2)

} // namespace Slab::Studios::Common::Monitors::V2

#endif // STUDIOSLAB_ISING_METROPOLIS_PASSIVE_MONITOR_WINDOW_V2_H
