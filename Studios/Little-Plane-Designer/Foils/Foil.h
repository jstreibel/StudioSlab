...
struct FAirfoilParams {
    ...
    // COM hint: 38% behind LE (NACA2412 usually sits 35-40% chord length)
    const b2Vec2 COM = b2Vec2{-.25f, -0.01f}; // COM from geometric center, in units of chord_length and thickness, respectively
    const b2Vec2 C4 = b2Vec2{0.0f, 0.0f}; // Chord C/4 from COM coordinates
};
