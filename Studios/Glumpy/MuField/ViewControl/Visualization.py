...
class Visualization(object):
    ...
    def _initProgram(self, GridDim: (float,float), SpaceDim: (float, float)) -> None:
        ...
        self.arrowProg = gloo.Program(ShaderDir + "PlaneShading.vert", ShaderDir + "PlaneShadingArrow.frag", version=130)
        self.arrowProg.bind(self.renderingPlane[0])
        self.arrowProg['Scale'] = (ratio, 1)

        self.colourProg = gloo.Program(ShaderDir + "PlaneShading.vert", ShaderDir + "PlaneShading.frag", version=130)
