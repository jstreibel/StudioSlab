...
#ifndef STUDIOSLAB_IMGUINODESTEST2_H
#define STUDIOSLAB_IMGUINODESTEST2_H
...
namespace Tests::Blueprints {
    ...
    class ImGuiNodesTest2 : public Slab::Graphics::SlabWindow {
        // From Application:
        std::string                 m_Name;
    ...
    public:
        ImGuiNodesTest2();              // OnStart()
        ~ImGuiNodesTest2() override;    // OnStop()
...
#endif //STUDIOSLAB_IMGUINODESTEST2_H
