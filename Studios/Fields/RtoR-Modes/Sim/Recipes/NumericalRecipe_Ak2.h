...
namespace Modes {
    ...
    class NumericalRecipe_Ak2 final : public Models::KGRtoR::FKGRtoR_Recipe {
        ...
        RealParameter Ak2              = RealParameter   (1.0,   FParameterDescription{'j', "Ak2", "Parameter (iota), ι=Ak²"});
        IntegerParameter wavelengths   = IntegerParameter(1,     FParameterDescription{"wavelengths", "Integer number of wavelengths within L"});
