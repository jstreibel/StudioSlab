...
#include "GraphCollections.h"



Graph &Base::getPhiGraph(Base::SectionPair &sectionPair) { return sectionPair.first.first; }
Graph &Base::getDtPhiGraph(Base::SectionPair &sectionPair) { return sectionPair.first.second; }
