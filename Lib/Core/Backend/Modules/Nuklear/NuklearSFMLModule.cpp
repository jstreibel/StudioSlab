...
Core::NuklearSFMLModule::NuklearSFMLModule()
: NuklearModule(SFML)
{
    try {
...
Core::NuklearSFMLModule::~NuklearSFMLModule() { nk_sfml_shutdown(); }

void Core::NuklearSFMLModule::event(const sf::Event &event) {
    nk_sfml_handle_event(&const_cast<sf::Event &>(event));
}

void Core::NuklearSFMLModule::endRender() {
