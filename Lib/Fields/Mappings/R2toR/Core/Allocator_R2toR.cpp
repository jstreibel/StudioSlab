...
#include "Fields/Mappings/R2toR/Model/R2toRFunctionArbitraryCPU.h"
#include "Fields/Mappings/R2toR/Model/R2ToRFunctionArbitraryGPU.h"
...
auto Allocator_R2toR::getSystemSolver() -> void * {
    ...
    return new Base::Equation_LorentzCovariant_2ndOrder<R2toR::FieldState>(*thePotential);
}
