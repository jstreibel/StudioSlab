...
#include <Studios/CoreMath/NativeFunctions.h>

/* (*Basic partial solutions for 0<t'<1/2 *) */

inline floatt vphiC (floatt t, floatt x, floatt v){ return .125*(sqr(1.+v-2.*x) - 4.*t*(1.+v-2.*v*x) + 4.*(2-v*v)*t*t) / (1.-v*v); }
...
inline floatt dtvphiC (floatt t, floatt x, floatt v){           return (t*(2.-v*v)-.5*(1.+v-2.*v*x)) / (1.-v*v)   ;}
...
inline floatt dxvphiL1(floatt t, floatt x, floatt v){ (void)x;  return -t/(1.+v)                                  ;}
...
inline floatt dxvphiL3(floatt t, floatt x, floatt v){ (void)x;  return (-.5+t)/(1.-v)                             ;}
inline floatt dtvphiR1(floatt t, floatt x, floatt v){           return t - (1.-x)/(1.-v)                          ;}
inline floatt dxvphiR1(floatt t, floatt x, floatt v){ (void)x;  return t/(1.-v)                                   ;}
...
inline floatt dxvphiR3(floatt t, floatt x, floatt v){ (void)x;  return (.5-t)/(1.+v)                              ;}
...
floatt dpsiC (floatt t, floatt x, floatt v, floatt u){ return gamma(u) * PiC (tau(xi), zeta, v) * (dtvphiC (tau(xi),  zeta, v) - u*sigma(xi)*dxvphiC (tau(xi),  zeta, v)); }
floatt dpsiL1(floatt t, floatt x, floatt v, floatt u){ return gamma(u) * PiL1(tau(xi), zeta, v) * (dtvphiL1(tau(xi),  zeta, v) - u*sigma(xi)*dxvphiL1(tau(xi),  zeta, v)); }
floatt dpsiR1(floatt t, floatt x, floatt v, floatt u){ return gamma(u) * PiR1(tau(xi), zeta, v) * (dtvphiR1(tau(xi),  zeta, v) - u*sigma(xi)*dxvphiR1(tau(xi),  zeta, v)); }
floatt dpsiL2(floatt t, floatt x, floatt v, floatt u){ return gamma(u) * PiL2(tau(xi), zeta, v) * (dtvphiL2(tau(xi),  zeta, v) - u*sigma(xi)*dxvphiL2(tau(xi),  zeta, v)); }
floatt dpsiR2(floatt t, floatt x, floatt v, floatt u){ return gamma(u) * PiR2(tau(xi), zeta, v) * (dtvphiR2(tau(xi),  zeta, v) - u*sigma(xi)*dxvphiR2(tau(xi),  zeta, v)); }
floatt dpsiL3(floatt t, floatt x, floatt v, floatt u){ return gamma(u) * PiL3(tau(xi), zeta, v) * (dtvphiL3(tau(xi),  zeta, v) - u*sigma(xi)*dxvphiL3(tau(xi),  zeta, v)); }
floatt dpsiR3(floatt t, floatt x, floatt v, floatt u){ return gamma(u) * PiR3(tau(xi), zeta, v) * (dtvphiR3(tau(xi),  zeta, v) - u*sigma(xi)*dxvphiR3(tau(xi),  zeta, v)); }


floatt dxiC (floatt t, floatt x, floatt v, floatt u){ return gamma(u) * PiC (tau(xi),  -zeta, v) * (dtvphiC (tau(xi), -zeta, v) + u*sigma(xi)*dxvphiC (tau(xi), -zeta, v)); }
floatt dxiL1(floatt t, floatt x, floatt v, floatt u){ return gamma(u) * PiL1(tau(xi),  -zeta, v) * (dtvphiL1(tau(xi), -zeta, v) + u*sigma(xi)*dxvphiL1(tau(xi), -zeta, v)); }
floatt dxiR1(floatt t, floatt x, floatt v, floatt u){ return gamma(u) * PiR1(tau(xi),  -zeta, v) * (dtvphiR1(tau(xi), -zeta, v) + u*sigma(xi)*dxvphiR1(tau(xi), -zeta, v)); }
floatt dxiL2(floatt t, floatt x, floatt v, floatt u){ return gamma(u) * PiL2(tau(xi),  -zeta, v) * (dtvphiL2(tau(xi), -zeta, v) + u*sigma(xi)*dxvphiL2(tau(xi), -zeta, v)); }
floatt dxiR2(floatt t, floatt x, floatt v, floatt u){ return gamma(u) * PiR2(tau(xi),  -zeta, v) * (dtvphiR2(tau(xi), -zeta, v) + u*sigma(xi)*dxvphiR2(tau(xi), -zeta, v)); }
floatt dxiL3(floatt t, floatt x, floatt v, floatt u){ return gamma(u) * PiL3(tau(xi),  -zeta, v) * (dtvphiL3(tau(xi), -zeta, v) + u*sigma(xi)*dxvphiL3(tau(xi), -zeta, v)); }
floatt dxiR3(floatt t, floatt x, floatt v, floatt u){ return gamma(u) * PiR3(tau(xi),  -zeta, v) * (dtvphiR3(tau(xi), -zeta, v) + u*sigma(xi)*dxvphiR3(tau(xi), -zeta, v)); }
