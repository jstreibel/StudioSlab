...
namespace Slab::Graphics {
    ...
    bool WindowRow::addWindow(const SlabWindow::Ptr &window, RelativePosition relPosition,
                              float windowWidth) {
    ...
    void WindowRow::removeWindow(const SlabWindow::Ptr &window) {
