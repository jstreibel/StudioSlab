...
namespace Slab {
    ...
    void Graphics::OpenGL::GLUT::write(const Window *win, const float fontScale, const float x, const float y,
    ...
    void Graphics::OpenGL::GLUT::writeOrtho(const Window *window, RectR region, float fontScale, float x, float y,
                                            std::string str,
                                            void *font) {
