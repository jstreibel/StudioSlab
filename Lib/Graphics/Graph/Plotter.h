...
namespace Slab::Graphics {
    ...
    public:
        ...
        static RtoRFunctionArtist_ptr      AddRtoRNumericFunction (PlottingWindow_ptr, const Math::RtoR::NumericFunction_ptr&,  PlotStyle,  Str name);
        static R2toRFunctionArtist_ptr     AddR2toRFunction(PlottingWindow_ptr, const Math::R2toR::NumericFunction_ptr&,                     Str name);
        static HistoryArtist_ptr           AddRtoRHistory  (PlottingWindow_ptr, const Math::R2toR::NumericFunction_ptr&,                     Str name);
