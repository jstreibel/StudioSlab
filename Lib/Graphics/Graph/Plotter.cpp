...
namespace Slab::Graphics {
    ...
    PointSetArtist_ptr
    Plotter::AddPointSet(const PlottingWindow_ptr& graph, const Math::PointSet_ptr &pointSet, PlotStyle plotStyle, Str label, bool affectsGraphRanges, int zOrder) {
    ...
    Plotter::AddCurve(const PlottingWindow_ptr& graph, const RtoR2::ParametricCurve_ptr &curve, PlotStyle plotStyle, Str label, int zOrder) {
    ...
    RtoRFunctionArtist_ptr
    Plotter::AddRtoRFunction(const PlottingWindow_ptr& graph, const RtoR::Function_ptr &function, PlotStyle plotStyle, Str label, Resolution samples, int zOrder) {
    ...
    RtoRFunctionArtist_ptr
    Plotter::AddRtoRNumericFunction(PlottingWindow_ptr, const RtoR::NumericFunction_ptr &, PlotStyle, Str label, int zOrder) {
        NOT_IMPLEMENTED
    }

    R2toRFunctionArtist_ptr Plotter::AddR2toRFunction(const PlottingWindow_ptr& graph, const R2toR::NumericFunction_constptr &function, Str label, int zOrder) {
    ...
    HistoryArtist_ptr Plotter::AddRtoRHistory(const PlottingWindow_ptr& graph, const R2toR::NumericFunction_constptr &function, Str label, int zOrder) {
    ...
    R2SectionArtist_ptr
    Plotter::AddR2Section(const PlottingWindow_ptr& graph, const R2toR::Function_constptr &function, Str name, int zOrder) {
