...
namespace Slab::Math {
    ...
    R2toR::FBoundaryCondition::FBoundaryCondition(R2toR::Function *initialPhiCondition,
    ...
    void R2toR::FBoundaryCondition::Apply(Base::EquationState &state, DevFloat t) const {
    ...
    void R2toR::FBoundaryCondition::apply_KGR2toR(EquationState &fieldState, DevFloat t) const {
        if (t == 0.0) {
