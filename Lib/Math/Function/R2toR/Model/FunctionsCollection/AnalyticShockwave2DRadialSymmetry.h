...
class AnalyticShockwave2DRadialSymmetry : public RtoR::Function {
        ...
        const UInt quant = 40;
        DevFloat a_k[40] =    {  1.,       2.43845,   4.04976,   5.77999,  7.60296,  9.50278, 11.4687, 13.4927, 15.5689, 17.6925,
        ...
        DevFloat beta_k[40] = {  0.,       2.66667 , -7.48737,  14.2453 ,-22.8108,  33.0932, -45.0237, 58.5473,-73.6183, 90.1981,
        ...
        DevFloat W_k(UInt k, DevFloat z) const;
    ...
    class AnalyticShockwave2DRadialSymmetryTimeDerivative : public RtoR::Function {
        ...
        DevFloat dW_kdz(UInt k, DevFloat z) const;
