...
namespace Slab::Math::Base {
    ...
    public:
        ...
        virtual EquationState& dtF(const EquationState &in, EquationState &out, Real t, Real dt) = 0;
        ...
        EquationState &operator()(const EquationState &in, EquationState &out, Real t, Real dt);
    };
