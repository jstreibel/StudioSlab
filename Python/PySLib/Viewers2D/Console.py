...
{    
    ...
    float x0 = position.x;
    float y0 = position.y;
    float x = x0+mod(pindex, cols);
    float y = y0+floor(pindex/cols);
...
class TextBuffer(object):
    ...
    def __init__(self, rows=24, cols=80, x=0, y=0, scale=2, fg_color=(0,0,0,1), bg_color=(0,0,0,0)):
        ...
        self._program["foreground"] = fg_color
        self._program["background"] = bg_color
        self._program['selection'] = -1,-1

        self._program['position'] = x, y
...
class Console(TextBuffer):
    ...
    def __init__(self, rows=24, cols=80, x=0, y=0, scale=2, cache=1000, no_events=False, visible=True,
                 fg_color=(0,0,0,1), bg_color=(0,0,0,0)):
        TextBuffer.__init__(self, rows, cols, x, y, scale, fg_color=fg_color, bg_color=bg_color)
        ...
        self._default_background = 0,0,0,1 # Transparent black
        self._default_style      = 0       # Regular
        self._buffer["style"]      = self._default_style

        self._no_events = no_events
